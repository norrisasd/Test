                            ...
                            <div class="carousel-inner">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="slider_cont">
                                                <h3>Best Service<br>You Can Experience</h3>
                                                <p>Our restaurant opens daily from 7:30 AM – 8:30 PM. Visit us at N. Bacalso Ave. or at bossingsrestaurant.com .</p>
                                                <a class="main_bt_border" href="<?php if(!isset($_SESSION['login'])){echo 'login.php';}else echo'user/order.php';?>">Order Now</a>
                                                
                                            </div>
                                        </div>
                                        <div class="col-md-7">
                                            <div class="slider_image full text_align_center">
                                                <img class="img-responsive" src="PHP PIC/pic2.png" style="border-radius:100px;height:500px;width:700px" alt="#" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="slider_cont">
                                                <h3>Food<br>That You Will Always Miss</h3>
                                                <p>Bossing’s Restaurant serves the best and affordable Pinoy food like Adobo, Bulalo, Pancit, Sinigang, and Sisig.</p>
                                                <a class="main_bt_border" href="<?php if(!isset($_SESSION['login'])){echo 'login.php';}else echo'user/order.php';?>">Order Now</a>
                                            </div>
                                        </div>
                                        <div class="col-md-7 full text_align_center">
                                            <div class="slider_image">
                                                <img class="img-responsive" src="PHP PIC/Fried Chicken.png" style="border-radius:100px; height:500px;width:700px" alt="#" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
      ...
      <div class="row">
         <div class="col-md-12">
             <div class="title">
                ...
                <span>Food and Services that comes from our restaurant are top class
                   <br> where customers are amazed by our restaurant
                </span>
             </div>
          </div>
       </div>
